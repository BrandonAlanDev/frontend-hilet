...
const Tabla = ({ headers, children, color }) => {
    return (
        <div className="lg:mt-0 select-none lg:w-[75vw] overflow-hidden rounded-3xl items-center shadow-2xl shadow-gray-900">
            <div className="flex flex-row items-start justify-center w-full h-full">
                <table className="w-full h-full bg-white">
                    <thead className={`bg-${color} text-white border-b-2 border-stone-300`}>
                        <tr>
